...
object AlarmScheduler {
    ...
    const val ACTION_PRAYER_ALARM = "com.sulfuro.salati.ACTION_PRAYER_ALARM"
    ...
    const val EXTRA_ADHAN_SOUND_ID = "EXTRA_ADHAN_SOUND_ID"
    ...
    suspend fun prepareAlarms(
        ...
        val monthData = mutableMapOf<YearMonth, Map<LocalDate, com.sulfuro.salati.core.computation.AladhanDayData>>()
    ...
    internal fun buildPreparedAlarms(
        ...
        hijriMetadata: Map<LocalDate, com.sulfuro.salati.core.computation.HijriDateParts>,
        settings: CalculationSettings,
        nowMillis: Long
