...
class ReleaseManifestPolicyTest {
    ...
    fun mainActivityCreatesChannelsBeforeSchedulingWithoutAutomaticPermissionPrompts() {
        val source = sourceFile("src/main/java/com/sulfuro/salati/MainActivity.kt").readText()
    ...
    fun mergedReleaseManifestUsesPermanentNonDebuggablePolicyAndApprovedExports() {
        ...
        assertEquals(
            setOf(
                "activity:com.sulfuro.salati.MainActivity",
                "service:androidx.work.impl.background.systemjob.SystemJobService",
                "receiver:androidx.work.impl.diagnostics.DiagnosticsReceiver",
                "receiver:androidx.profileinstaller.ProfileInstallReceiver",
                "receiver:com.sulfuro.salati.widget.SalatiAppWidgetProvider",
                "receiver:com.sulfuro.salati.widget.SalatiMinimalBarWidgetProvider",
                "receiver:com.sulfuro.salati.widget.SalatiCompactWidgetProvider",
                "receiver:com.sulfuro.salati.widget.SalatiGlanceWidgetProvider"
            ),
            exported
        )
    }
