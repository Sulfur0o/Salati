...
class AlarmRelevantSettingsTest {
    ...
    fun safeZoneIdFallsBackToSystemDefaultOnInvalidOrEmptyTimezone() {
        ...
        assertEquals(java.time.ZoneId.of("Europe/Brussels"), com.sulfuro.salati.data.settings.safeZoneId(valid.timezoneId))

        val invalid = CalculationSettings(timezoneId = "Invalid/Timezone_Name")
        assertEquals(java.time.ZoneId.systemDefault(), com.sulfuro.salati.data.settings.safeZoneId(invalid.timezoneId))

        val empty = CalculationSettings(timezoneId = "")
        assertEquals(java.time.ZoneId.systemDefault(), com.sulfuro.salati.data.settings.safeZoneId(empty.timezoneId))
    }
}
